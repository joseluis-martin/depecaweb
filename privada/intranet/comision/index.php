...
do
    {
        ...
        if($row['id']){
            $com=$row['id']; 
			if ($row["orden"]<>11){ // Solo para el listado de cargos de los profesores
            ...
            if (($autorizado==true)||($user=="mocana")||($user=="revenga")|| $user=="jlmartin")
                {
					...
					if ($row["orden"]<>11){ // Solo para el listado de cargos de los profesores
						...
						echo "<td width='55%'><div align='right'><span class='generalbluebold'>Cargos</span> \n";
					}
			...
			if ($row["orden"]<>11){ // Solo para el listado de cargos de los profesores
				...
				echo "<table  width='100%' border='0' align='center'><tr><td class='encabezado'><b><font color='#FFFFFF' size='4' face='Arial'>Listado de cargos del profesorado</td><td class='encabezado'><font color='#FFFFFF' size='4' face='Arial'><b>Fecha</font></b></td></tr>";
			}
