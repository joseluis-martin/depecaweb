...
$sqli[1]="SELECT ha.cod_asig, a.codigo_titulacion, a.cod_dpto as def, CONCAT(a.codigo_titulacion,ha.cod_asig) as name FROM horas_asignatura as ha inner join asignaturas as a on ha.cod_asig=a.codigo where ha.curso='2023/2024' and 
...
$sqli[2]="UPDATE horas_asignatura SET cod_dpto='#cod_dpto#' WHERE cod_asig=#codigo# AND curso='2023/2024'";    
