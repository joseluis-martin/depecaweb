...
<?
$section2_end = get_microtime();
$section2_elapsed = $section2_end - $section2_start;
//echo "Tiempo transcurrido en la seccion 1: " . $section2_elapsed . " segundos<br>";
?>

<?
$section3_start = get_microtime();
?>
...
<?
$section3_end = get_microtime();
$section3_elapsed = $section3_end - $section3_start;
//echo "Tiempo transcurrido en la seccion 1: " . $section3_elapsed . " segundos<br>";
?>
