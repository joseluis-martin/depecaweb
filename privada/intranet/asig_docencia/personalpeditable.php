...
<?
 ...
 echo "<div align='center'><b><font size='3' face='Tahoma'>Clic sobre el nombre a EDITAR</font></b></div>\n";
...
while($row2 = mysql_fetch_array($result2))
 {
   ...
   if ($row1 = mysql_fetch_array($result1)){
     ...
     do {
       ...
       echo "<td class='encabezado'><b><font class='fuenteblanco'><a href='./formularios/personal/editpersonal.php?id=".$row1["id"]."'>$nombre2</a></font></b></td> \n";
