...
<div align="center">
  ...
  <form method="post" action="inscarreraprue.php">
...
<tr align='left'> 
        <td width="40%"><font size="2" face="Arial" color="#0073B4"><b>Formaci&oacute;n  B&aacute;sica</b></font></td>
        <td width="56%"><font size="1" face="Arial"> <input name="formacion_basica" type="text" size="50">
          </font></td>
	</tr>
      <tr align='left'> 
        <td width="40%"><font size="2" face="Arial" color="#0073B4"><b>Cr&eacute;ditos Obligatorias</b></font></td>
         <td width="56%"><font size="1" face="Arial">
        	<input name="obligatorias" type="text" size="50">
          </font></td>
      </tr>
      <tr align='left'> 
